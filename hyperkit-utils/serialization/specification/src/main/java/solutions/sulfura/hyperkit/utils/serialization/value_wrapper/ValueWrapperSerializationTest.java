...
public abstract class ValueWrapperSerializationTest {
    ...
    void testSerializeString() throws IOException {
        ...
        // When serializing it
        String json = serializationProvider.write(wrapper, null);
    ...
    void testDeserializeString() throws IOException {
        ...
        ValueWrapper<String> deserialized = deserializationProvider.read(json, ValueWrapper.class, null);
    ...
    void testDeserializeNumber() throws IOException {
        ...
        ValueWrapper<Integer> deserialized = deserializationProvider.read(json, ValueWrapper.class, null);
    ...
    void testDeserializeNull() throws IOException {
        ...
        // When deserializing the JSON string
        ValueWrapper<Object> deserialized = deserializationProvider.read(json, ValueWrapper.class, null);
    ...
    void testSerializeEmpty() throws IOException {
        ...
        String emptyWrapperJson = serializationProvider.write(wrapper, null);

        // Then the resulting JSON must be the same as serializing a null value
        String nullJson = serializationProvider.write(null, null);
    ...
    void testSerializeEmptyFields() throws IOException {
        ...
        // When serializing the empty wrapper into JSON format
        String json = serializationProvider.write(dto, null);
    ...
    void testSerializeEmptyArrayElements() throws IOException {
        ...
        // When serializing the empty wrapper into JSON format
        String setOfEmptyValueWrappersJson = serializationProvider.write(setOfEmptyValueWrappers, null);

        // Then the resulting JSON matches the json of a set with a null element
        String setOfNullJson = serializationProvider.write(setOfNull, null);
    ...
    void testDeserializeComplex() throws IOException {
        ...
        // When
        ValueWrapper<?> deserialized = deserializationProvider.read(json, ValueWrapper.class, null);
    ...
    void testSerializeNestedWrapper() throws IOException {
        ...
        String json = serializationProvider.write(outerWrapper, null);
    ...
    void testDeserializeFromEmptyJson() throws IOException {
        ...
        assertThrows(RuntimeException.class, () -> deserializationProvider.read(json, ValueWrapper.class, null));
    }
    ...
    void testDeserializeAbsentProperty() throws IOException {
        ...
        TestValueWrapperContainer deserialized = deserializationProvider.read(json, TestValueWrapperContainer.class, null);
    ...
    void testSerializeObjectWithValueWrapper() throws IOException {
        ...
        String json = serializationProvider.write(container, null);
