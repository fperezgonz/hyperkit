...
include("hyperkit-spring-support:boot-starter")
include("hyperkit-spring-support:boot-starter-web")
include("hyperkit-spring-support:boot-starter-jpa")
include("hyperkit-spring-support:boot-starter-openapi")
include("hyperkit-spring-support:boot-starter-jackson2")
include("hyperkit-spring-support:message-converter-jackson2")
include("hyperkit-spring-support:message-converter-jackson3")
include("hyperkit-spring-support:openapi")
include("hyperkit-spring-support:jpa")
include("hyperkit-spring-support:projection-field-alias-specification")
include("hyperkit-spring-support:web")
