...
include("hyperkit-utils:spring-jackson2")
include("hyperkit-utils:spring-jackson3")
include("hyperkit-utils:spring-openapi")
include("hyperkit-utils:spring-persistence")
include("hyperkit-utils:spring-projection-field-alias-specification")
include("hyperkit-utils:spring-web")
