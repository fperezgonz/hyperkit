...
public class DtoProjectionReturnArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    private final CachedProjectionParser projectionCache;

    public DtoProjectionReturnArgumentResolver(Optional<ProjectionAnnotationCache> projectionAnnotationCache,
                                               Optional<CachedProjectionParser> projectionCache) {
    ...
    public Object resolveArgument(@Nonnull MethodParameter parameter, ModelAndViewContainer mavContainer,
        ...
        DtoProjectionSpec projectionAnnotation = null;
        if (projectionAnnotationCache != null) {
            projectionAnnotation = projectionAnnotationCache.getReturnTypeAnnotation(parameter.getMethod());
        } else {
            getMethodProjectionAnnotationOrMetaAnnotation(parameter.getMethod());
        }
        ...
        if (projectionCache != null) {
            return projectionCache.get(projectionAnnotation);
        }
