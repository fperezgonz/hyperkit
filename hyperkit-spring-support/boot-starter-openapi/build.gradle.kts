...
publishing {
    publications {
        create<MavenPublication>("maven") {
            artifactId = "hyperkit-boot-starter-openapi"
            from(components["java"])

            pom {
                name = "HyperKit Boot Starter"
                description =
                    "A spring boot starter that autoconfigures Hyperkit integration with SpringDoc"
                url = "https://gitlab.com/sulfura/hyperkit/-/tree/master/hyperkit-spring-support/boot-starter-openapi"
                inceptionYear = "2023"
                licenses {
                    license {
                        name = "Apache-2.0"
