...
publishing {
    publications {
        create<MavenPublication>("maven") {
            artifactId = "hyperkit-jackson2-boot-starter"
            ...
            pom {
                ...
                url = "https://gitlab.com/sulfura/hyperkit/-/tree/master/hyperkit-spring-support/spring-jackson2-boot-starter"
                inceptionYear = "2023"
                licenses {
                    license {
                        name = "Apache-2.0"
...
dependencies {
    ...
    testImplementation(project(":hyperkit-spring-support:spring-boot-starter"))
