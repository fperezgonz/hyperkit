    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                url = "https://gitlab.com/sulfura/hyperkit/-/tree/master/hyperkit-spring-support/boot-starter"
                inceptionYear = "2023"
                licenses {
                    license {
                        name = "Apache-2.0"
...
dependencies {
    ...
    api(project(":hyperkit-spring-support:jpa"))
    api(project(":hyperkit-spring-support:boot-starter-jpa"))
    api(project(":hyperkit-spring-support:web"))
    api(project(":hyperkit-spring-support:boot-starter-web"))
    api(project(":hyperkit-spring-support:openapi"))
    api(project(":hyperkit-spring-support:boot-starter-openapi"))
