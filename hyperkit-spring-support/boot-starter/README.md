...
To use Hyperkit in your Spring Boot project, add the hyperkit-boot-starter dependency to your build file:

#### Gradle
```gradle
implementation 'solutions.sulfura:hyperkit-boot-starter:latest.version'
```
...
<dependency>
    ...
    <artifactId>hyperkit-boot-starter</artifactId>
...
- [hyperkit-spring-support](..): Spring utilities including HyperMapper and argument resolvers
