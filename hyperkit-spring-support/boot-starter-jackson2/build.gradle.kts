...
publishing {
    publications {
        create<MavenPublication>("maven") {
            artifactId = "hyperkit-boot-starter-jackson2"
            from(components["java"])

            pom {
                name = "HyperKit Jackson2 Boot Starter"
                description =
                    "A spring boot starter that autoconfigures Hyperkit jackson2 compatibility"
                url = "https://gitlab.com/sulfura/hyperkit/-/tree/master/hyperkit-spring-support/boot-starter-jackson2"
                inceptionYear = "2023"
                licenses {
                    license {
                        name = "Apache-2.0"
...
dependencies {
    ...
    api(project(":hyperkit-spring-support:message-converter-jackson2"))

    // Test dependencies
    testImplementation(project(":hyperkit-spring-support:boot-starter"))
