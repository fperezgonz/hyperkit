...
publishing {
    publications {
        create<MavenPublication>("maven") {
            artifactId = "hyperkit-spring-support-jpa"
            from(components["java"])

            pom {
                name = "HyperKit Spring JPA utils"
                description = "Utils for integration of Hyperkit DTOs and projections with Spring JPA"
                url = "https://gitlab.com/sulfura/hyperkit/-/tree/master/hyperkit-spring-support/jpa"
                inceptionYear = "2023"
                licenses {
                    license {
                        name = "Apache-2.0"
