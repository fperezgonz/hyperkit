...
publishing {
    publications {
        create<MavenPublication>("maven") {
            artifactId = "hyperkit-boot-starter-jpa"
            from(components["java"])

            pom {
                name = "HyperKit JPA Boot Starter"
                description =
                    "A spring boot starter that autoconfigures Hyperkit JPA utils on Spring Boot applications"
                url = "https://gitlab.com/sulfura/hyperkit/-/tree/master/hyperkit-spring-support/boot-starter-jpa"
                inceptionYear = "2023"
                licenses {
                    license {
                        name = "Apache-2.0"
