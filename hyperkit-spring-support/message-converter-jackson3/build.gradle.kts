...
publishing {
    publications {
        create<MavenPublication>("maven") {
            artifactId = "hyperkit-spring-support-jackson3"
            from(components["java"])

            pom {
                name = "HyperKit Spring Jackson3 utils"
                description = "Support for projection-aware serialization and deserialization of Hyperkit DTOs using jackson 2"
                url = "https://gitlab.com/sulfura/hyperkit/-/tree/master/hyperkit-spring-support/message-converter-jackson3"
                inceptionYear = "2023"
                licenses {
                    license {
                        name = "Apache-2.0"
...
dependencies {
    ...
    testImplementation(project(":hyperkit-spring-support:projection-field-alias-specification"))
