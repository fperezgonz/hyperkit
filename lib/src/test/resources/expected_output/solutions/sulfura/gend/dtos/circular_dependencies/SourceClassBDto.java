...
public class SourceClassBDto implements Dto<SourceClassB>{
    ...
    public static class Builder{
        ...
        public Builder propertyArray(Option<List<solutions.sulfura.gend.dtos.circular_dependencies.SourceClassADto>> propertyArray){
        ...
        public Builder genericPropertyArray(Option<List<List<solutions.sulfura.gend.dtos.circular_dependencies.SourceClassA>>> genericPropertyArray){
