...
publishing {
    publications {
        create<MavenPublication>("maven") {
            artifactId = "hyperkit-projection-spec-validator"
            from(components["java"])

            pom {
                name = "HyperKit Projection Spec Validator"
                description = "Validator for HyperKit DtoProjectionSpec annotations"
                url = "https://gitlab.com/sulfura/hyperkit/-/tree/master/hyperkit-projection-spec-validator"
                inceptionYear = "2025"
                licenses {
                    license {
                        name = "Apache-2.0"
